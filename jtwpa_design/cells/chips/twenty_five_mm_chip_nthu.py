...
from jtwpa_design.cells.chips.spiral_nthu import spiral_chip_nthu
...
def twenty_five_mm_chip_nthu(
    ...
    for i in range(len(test_chip_points)):
        test_chip_ref = temp << test_chip_nthu(
    ...
    for i in range(len(spiral_chip_points)):
        spiral_chip_ref = temp << spiral_chip_nthu(
